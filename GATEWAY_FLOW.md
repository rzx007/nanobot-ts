...
│  7. 启动 CronService (定时任务服务)                                                │
│  8. 初始化 MemoryConsolidator (记忆整合器)                                         │
│  9. 初始化 SkillLoader (技能加载器)                                               │
│ 10. 创建 AgentLoop (Agent主循环)                                                   │
│ 11. 初始化 ChannelManager (渠道管理器)                                             │
│ 12. 注册 CLIChannel                                                                 │
│ 13. 加载配置中的渠道 (WhatsApp, Feishu, Email)                                    │
│ 14. 启动所有渠道                                                                    │
│ 15. 启动出站消费循环 (runOutboundLoop)                                             │
│ 16. 启动 Agent 主循环 (agent.run())                                                │
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
